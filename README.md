# In control theory, the solution to the state at every point in time is given by the variation-of-constants formula. For linear-time-invariant (LTI) systems, it involves the matrix exponential: 
...
# The primary way to determine it is by computing the Peano-Baker series: a series of nested integrals of A(t) given as follows:
