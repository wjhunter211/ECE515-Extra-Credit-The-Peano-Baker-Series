...
$$\phi(t, t_0)=I+\int_{t_0}^{t}A(s_1)\,ds_1+\int_{t_0}^{t}A(s_1)\!\int_{t_0}^{s_1}A(s_2)\,ds_2\,ds_1+\int_{t_0}^{t}A(s_1)\!\int_{t_0}^{s_1}A(s_2)\!\int_{t_0}^{s_2}A(s_3)\,ds_3\,ds_2\,ds_1+\cdots$$
